...
const Reviews = ({ review }) => {
  const { name, rating, des, img } = review;
  return (
    <div class="md:max-w-md rounded-xl border shadow-2xl p-4 my-6">
      <div class="flex flex-col items-center pb-10">
        ...
        <h5 class="mb-1 text-3xl font-medium text-accent">{name}</h5>
        <p class="text-md text-gray-500 font-medium leading-6 py-4">{des}</p>
        <div class="flex items-center m3-2">
